...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 171.30
  #define DEFAULT_bedKi 33.73
  #define DEFAULT_bedKd 580.03
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 139.48 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -3, -2.4 }
...
#define HOMING_FEEDRATE_MM_M { (100*60), (60*60), (20*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 5), (Y_MIN_POS), 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  X_MAX_POS, 10, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { (X_MAX_POS - 10), 10, (Z_MIN_POS + 1) } }
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL 300 // (minutes) EEPROM save interval during print
#endif
